...
def _tls_record(tls: Any) -> dict[str, Any] | None:
    if tls is None:
        return None
    return {
        "addressofCallbacks": numeric_value(_safe(tls, "addressof_callbacks", 0)),
        "addressofIndex": numeric_value(_safe(tls, "addressof_index", 0)),
        "addressofRawData": numeric_value(_safe(tls, "addressof_raw_data", 0)),
        "sizeofZeroFill": numeric_value(_safe(tls, "sizeof_zero_fill", 0)),
        "characteristics": numeric_value(_safe(tls, "characteristics", 0)),
    }
