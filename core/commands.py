        ...
        try:
            ...
            for command in reversed(executed):
                try:
                    ...
                    # Best-effort undo: a rollback failure must not mask the original
                    # failure, which is re-raised below.
                    pass
            raise
...
class CommandHistory:
    ...
    execute/undo are live through PluginContext for history-backed plugins;
    can_undo/can_redo/redo/execute_group complete the transactional contract
    (TODO CMD-01..05) and are exercised by the command regression tests.
    """
