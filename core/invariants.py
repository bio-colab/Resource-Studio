        ...
        result.append(
            {
                ...
                "address": numeric_value(getattr(item, "address", 0)),
                "ordinal": numeric_value(getattr(item, "ordinal", 0)),
...
def _tls(binary: Any) -> dict[str, Any] | None:
    ...
    if value is None:
        return None
    return {"callbacks": numeric_value(getattr(value, "addressof_callbacks", 0)), "index": numeric_value(getattr(value, "addressof_index", 0)), "rawData": numeric_value(getattr(value, "addressof_raw_data", 0)), "zeroFill": numeric_value(getattr(value, "sizeof_zero_fill", 0)), "characteristics": numeric_value(getattr(value, "characteristics", 0))}
