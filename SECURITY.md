...
لا يعرض الخادم أداة تنفيذ أوامر عامة، ولا أداة كتابة مسار عام، ولا أداة تحميل URL ثم تشغيله. كل وظيفة محددة باسم ومخطط ومدخلات مقيدة. استدعاء Resource Hacker إن استُخدم يكون من adapter داخلي بوسائط مصفوفية، مع مسارات محققة، ووقت أقصى، وقراءة stdout/stderr وسجل العملية.
