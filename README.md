...
| Windows shell | WPF مستقل فوق CLI، Verification summary، async CLI runner، Stop، Preview مع field-to-byte hex selection، Resource Grid triage coloring، Image Wizard، وUI automation |
