...
النواة لا تعرف الواجهة الرسومية ولا MCP ولا Resource Hacker. تستقبل نموذج مشروع، وتنفذ أوامر على الذاكرة، وتحفظ صيغة مشروع مستقلة عند طلب الحفظ. بهذا يمكن لاحقًا استخدام النواة من واجهة Windows أو CLI أو plugin host دون تكرار المنطق.
